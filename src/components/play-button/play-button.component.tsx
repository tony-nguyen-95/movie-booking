...
import './play-button.style.scss';
import { IPlayButtonProps } from './play-button.type';

const prefixClassName = 'play-button';

export const PlayButton: React.FC<IPlayButtonProps> = (props) => {
  return (
